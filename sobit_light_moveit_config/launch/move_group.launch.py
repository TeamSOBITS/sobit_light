...
def generate_launch_description():
    ...
    package_name_gazebo = 'sobit_light_description'
    ...
    # urdf_file_path = 'sobit_light_description/robots/sobit_light_robot.urdf.xacro'
    srdf_file_path = 'config/sobit_light.srdf'
    ...
    # Set the full paths
    urdf_model_path = os.path.join(pkg_share_gazebo, 'robots', 'sobit_light_robot.urdf.xacro')
    ...
    start_move_group_node_cmd = Node(
        ...
        parameters=[
            ...
            # {"planning_frame": "sobit_light/base_footprint"},
        ],
        remappings=[
    ...
    start_rviz_node_cmd = Node(
        ...
        # remappings=[
        #     # ("/joint_states", "/sobit_light/joint_states"),
        #     # ("/robot_description", "/sobit_light/robot_description"),
        # ]
    )

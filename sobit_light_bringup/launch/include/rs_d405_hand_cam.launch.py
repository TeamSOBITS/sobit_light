...
configurable_parameters = [{'name': 'camera_name',                  'default': 'hand_camera', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'sobit_light', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "'127122270582'", 'description': 'choose device by serial number'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '848,480,10', 'description': 'depth stream profile'},

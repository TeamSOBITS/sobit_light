...
PYBIND11_MODULE(sobit_light_module, m) {
  ...
  pybind11::class_<sobit_light::WheelController, std::shared_ptr<sobit_light::WheelController>>(m, "WheelController")
    .def(pybind11::init<const std::string&>())
    .def("controlWheelLinear", &sobit_light::WheelController::controlWheelLinear, "Control Wheel Linear",
        pybind11::arg("distance"))
    .def("controlWheelRotateRad", &sobit_light::WheelController::controlWheelRotateRad, "Control Wheel Rotate Rad",
        pybind11::arg("angle_rad"))
    .def("controlWheelRotateDeg", &sobit_light::WheelController::controlWheelRotateDeg, "Control Wheel Rotate Deg",
        pybind11::arg("angle_deg"))
    .def("rad2Deg", &sobit_light::WheelController::rad2Deg, "Convert Radians to Degrees",
        pybind11::arg("rad"))
    .def("deg2Rad", &sobit_light::WheelController::deg2Rad, "Convert Degrees to Radians",
        pybind11::arg("deg"));
}
